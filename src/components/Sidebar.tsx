...
const Sidebar = () => {
  return (
    <div className="h-screen border-r px-2 fixed top-0 left-0 flex flex-col justify-between">
      <div className="flex flex-col items-center gap-2 pt-20">
        <div className="rounded-full p-2 border">
          <User size={18} className="stroke-[1.2]" />
        </div>

        <div className="rounded-full p-2 border">
          <Link size={18} className="stroke-[1.2]" />
        </div>
      </div>
